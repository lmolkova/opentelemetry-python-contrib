...
- Use `EmbeddingInvocation` from `opentelemetry-util-genai` in the latest experimental
  semantic conventions path (`OTEL_SEMCONV_STABILITY_OPT_IN=gen_ai_latest_experimental`)
